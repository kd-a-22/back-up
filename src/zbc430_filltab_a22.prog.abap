...
* Replace # by Your user-number and remove all * from here
  ...
  DELETE FROM ztsbook_a22.
  DELETE FROM ztscustom_a22.


  SELECT * FROM sbook INTO wa_sbook.
    INSERT INTO ztsbook_a22 VALUES wa_sbook.
  ENDSELECT.
  ...
  IF sy-subrc = 0.
    ...
    IF sy-subrc = 0.
      ...
      SELECT * FROM scustom INTO wa_custo.
        INSERT INTO ztscustom_a22 VALUES wa_custo.
      ENDSELECT.
      IF sy-subrc <> 0.
        my_error = 1.
      ENDIF.
