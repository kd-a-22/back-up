...
*g_mode = 'A'.   "  E,  N,
  ...
  CALL METHOD cl_gui_frontend_services=>file_open_dialog    " 파일을 불러오는 메소드.
    EXPORTING
...
*
  ...
  CALL FUNCTION 'GUI_UPLOAD'             " upload 펑션.
    EXPORTING
      filename            = filename
      filetype            = 'ASC'
...
*
*  CALL FUNCTION 'WS_FILENAME_GET'      " 옛날 버전.. 펑션모듈 버전..
*       EXPORTING
**           DEF_FILENAME     = ' '
*          def_path         = 'C:\'
*          mask             = ',*.*,*.*.'
